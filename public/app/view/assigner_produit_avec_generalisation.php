    ...
    <?php    
        ...
        for ($compteur = 0; $compteur < count($tabJeuProduits); $compteur++)
        {
            ...
            if ($jeuProduits != $tabJeuProduits[$compteur]['jeu'])
            {
                ...
                //verifie la presence de generalisation
                for ($quatre = 0; $quatre < 4; $quatre++)
                {
                    if ($tabJeuProduits[$compteur]["n".$quatre] == 't')
                    {
                        $compt[] = $quatre;
                        $flag++;
                    }
                ...
                if ($flag != 0)
                {
                    echo "<li class='liProduits'><b  id='produitsDeploi".$tabJeuProduits[$compteur]["symbole"]."' class='produitsDeploi'>></b><label class='produitsDeploi' id='produitsDeploi".$tabJeuProduits[$compteur]["symbole"]."'>".$tabJeuProduits[$compteur]["symbole"]."</label>";
                    
                    foreach ($compt as $nombre)
                    {
                        echo "<ul class='produits".$tabJeuProduits[$compteur]["symbole"]."' id='produits_ul'><input type=\"submit\" class='boutonJeu' id='produits".$tabJeuProduits[$compteur]["symbole"]."_n".$nombre."' value='".$tabJeuProduits[$compteur]["symbole"]."_n".$nombre."' name='jeu'></ul>";
                    }
